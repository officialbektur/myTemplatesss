...
*/
//========================================================================================================================================================
const differencesSlider = document.querySelector(
  ".body-cards-prices__wrapper_one"
);
const differencesSliderTwo = document.querySelector(
  ".body-cards-prices__wrapper_two"
);
let sliderOnePipe;
...
function mobileSliderTwo() {
  ...
  if (window.innerWidth > 991.98) {
    differencesSliderTwo.dataset.mobile = "false";
    if (
      differencesSliderTwo.classList.contains("swiper-container-initialized")
    ) {
